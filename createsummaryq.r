create_summary1 <- function(input_path) {
	##load("C:\\Users\\Atul\\Desktop\\summ\\qt.Rdata")
	load("C:\\Users\\Atul\\Desktop\\summ\\q.Rdata")
	...
	source("C:\\Users\\Atul\\Desktop\\summ\\makesummaryq.R")
	...
	for(qwerty in 1 : length(corpus)){
		...
		sumq <- makesummaryq(corpus, qwerty, q)
