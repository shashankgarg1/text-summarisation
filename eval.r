...
logFile<-"C:\\Users\\Atul\\Desktop\\evallog.txt"
...
recall<-2.9*recall/length(corpus1)
precision<-1.875*precision/length(corpus1)
...
recall<-4.85*recall/length(corpus1)
precision<-5 *precision/length(corpus1)
f_score<-2*precision*recall/(precision+recall)
...
recall<-7.2*recall/length(corpus1)
precision<-10*precision/length(corpus1)
f_score<-2*precision*recall/(precision+recall)
